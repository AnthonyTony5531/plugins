...
const dynamic lolRadioTypes = {
  ...
  'CT': {
    'col': 2,
    "col188": 1,
    'text': {'CT33': 'Before 35:00', 'CT34': 'After 35:01'},
    'sort': ['CT33', 'CT34']
  },
  'M_FW1': {
    'col': 2,
  ...
  'M_CT1': {
    'col': 2,
    'text': {'M_CT1O': 'Over {ratio}', 'M_CT1U': 'Under {ratio}'},
    'sort': ['M_CT1O', 'M_CT1U']
  },
  'M_FB1': {
    'col': 2,
  ...
  'M_CT2': {
    'col': 2,
    'text': {'M_CT2O': 'Over {ratio}', 'M_CT2U': 'Under {ratio}'},
    'sort': ['M_CT2O', 'M_CT2U']
  },
  'M_FB2': {
    'col': 2,
  ...
  'M_FEO1': {
    'col': 2,
    'text': {'M_FEO1O': 'Odd', 'M_FEO1E': 'Even'},
    'sort': ['M_FEO1O', 'M_FEO1E']
  },
  'M_FOU1': {
    'col': 2,
    'text': {'M_FOU1H': 'Over {ratio}', 'M_FOU1C': 'Under {ratio}'},
  ...
  'M_FEO2': {
    'col': 2,
    'text': {'M_FEO2O': 'Odd', 'M_FEO2E': 'Even'},
    'sort': ['M_FEO2O', 'M_FEO2E']
  },
  'M_FOU2': {
    'col': 2,
    'text': {'M_FOU2H': 'Over {ratio}', 'M_FOU2C': 'Under {ratio}'},
