const dynamic lolRadioTypes = {
  ...
  'CT': {
    'col': 2,
    'text': {'CT33': '35:00 hoặc dưới', 'CT34': '35:01 hoặc trên'},
    'sort': ['CT33', 'CT34']
  },
  ...
  'M_CT1': {
    'col': 2,
    'text': {'M_CT1O': 'Tài {ratio}', 'M_CT1U': 'Xỉu {ratio}'},
    'sort': ['M_CT1O', 'M_CT1U']
  },
  'M_FB1': {
    'col': 2,
  ...
  'M_CT2': {
    'col': 2,
    'text': {'M_CT2O': 'Tài {ratio}', 'M_CT2U': 'Xỉu {ratio}'},
    'sort': ['M_CT2O', 'M_CT2U']
  },
  'M_FB2': {
    'col': 2,
  ...
  'M_FEO1': {
    'col': 2,
    'text': {'M_FEO1O': 'Lẻ', 'M_FEO1E': 'Chẵn'},
    'sort': ['M_FEO1O', 'M_FEO1E']
  },
  'M_FOU1': {
    'col': 2,
    'text': {'M_FOU1H': 'Tài {ratio}', 'M_FOU1C': 'Xỉu {ratio}'},
  ...
  'M_FEO2': {
    'col': 2,
    'text': {'M_FEO2O': 'Lẻ', 'M_FEO2E': 'Chẵn'},
    'sort': ['M_FEO2O', 'M_FEO2E']
  },
  'M_FOU2': {
    'col': 2,
    'text': {'M_FOU2H': 'Tài {ratio}', 'M_FOU2C': 'Xỉu {ratio}'},
