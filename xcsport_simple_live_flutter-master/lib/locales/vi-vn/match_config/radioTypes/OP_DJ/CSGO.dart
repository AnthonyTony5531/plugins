...
const dynamic csgoRadioTypes = {
  ...
  'MOU_RT': {
    'col': 2,
    'text': {'MOU_RTO': 'Tài {ratio}', 'MOU_RTU': 'Xỉu {ratio}'},
  ...
  'MEO_MR': {
    'col': 2,
    'text': {'MEO_MRO': 'Lẻ', 'MEO_MRE': 'Chẵn'},
    'sort': ['MEO_MRO', 'MEO_MRE']
  },
  'MOU_TH': {
    'col': 2,
    'text': {'MOU_THO': 'Tài {ratio}', 'MOU_THU': 'Xỉu {ratio}'},
    'sort': ['MOU_THO', 'MOU_THU']
  },
  'MOU_RXT': {
    'col': 2,
    'text': {'MOU_RXTO': 'Tài {ratio}', 'MOU_RXTU': 'Xỉu {ratio}'},
  ...
  'MOU_TKH': {
    'col': 2,
    'text': {'MOU_TKHO': 'Tài {ratio}', 'MOU_TKHU': 'Xỉu {ratio}'},
    'sort': ['MOU_TKHO', 'MOU_TKHU']
  },
  'MOU_TKC': {
    'col': 2,
    'text': {'MOU_TKCO': 'Tài {ratio}', 'MOU_TKCU': 'Xỉu {ratio}'},
    'sort': ['MOU_TKCO', 'MOU_TKCU']
  },
  'MRBP': {
    'col': 2,
    'text': {'MRBPY': 'Có', 'MRBPN': 'Không'},
    'sort': ['MRBPY', 'MRBPN']
  },
  'MRBD': {
    'col': 2,
    'text': {'MRBDY': 'Có', 'MRBDN': 'Không'},
    'sort': ['MRBDY', 'MRBDN']
  },

  // 7.23 Đã thêm trò chơi thể thao điện tử
  'M': {
    'col': 2,
