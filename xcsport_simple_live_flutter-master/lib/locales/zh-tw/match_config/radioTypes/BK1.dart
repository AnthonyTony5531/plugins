...
const dynamic bkRadioTypes = {
  ...
  "WM": {
    ...
    "col188": 1,
    "text": {
      "WMH12":"{homeTeam} 贏1-2分",
      "WMH36":"{homeTeam} 贏3-6分",
      "WMH79":"{homeTeam} 贏7-9分",
      "WMH1013":"{homeTeam} 贏10-13分",
      "WMH1416":"{homeTeam} 贏14-16分",
      "WMH1720":"{homeTeam} 贏17-20分",
      "WMH21OV":"{homeTeam} 贏21分以上",
      "WMC12":"{awayTeam} 贏1-2分",
      "WMC36":"{awayTeam} 贏3-6分",
      "WMC79":"{awayTeam} 贏7-9分",
      "WMC1013":"{awayTeam} 贏10-13分",
      "WMC1416":"{awayTeam} 贏14-16分",
      "WMC1720":"{awayTeam} 贏17-20分",
      "WMC21OV":"{awayTeam} 贏21分以上",

      "WMH15":"{homeTeam} 贏1-5分",
      "WMH610":"{homeTeam} 贏6-10分",
      "WMH1120":"{homeTeam} 贏11-20分",
      "WMH2125":"{homeTeam} 贏21-25分",
      "WMH26OV":"{homeTeam} 贏26分以上",
      "WMC15":"{awayTeam} 贏1-5分",
      "WMC610":"{awayTeam} 贏6-10分",
      "WMC1120":"{awayTeam} 贏11-20分",
      "WMC2125":"{awayTeam} 贏21-25分",
      "WMC26OV":"{awayTeam} 贏26分以上",

      "WMH3":"{homeTeam} 會贏3分以上",
      "WMC3":"{awayTeam} 會贏3分以上",
      "WMO":"其他分數",
    },
    "sort": [
      "WMH3",
  ...
  "OEU": {
    "col": 3,
    "col188": 1,
    "text": {"OEUU": "低於{total}分", "OEUE": "等於{total}分", "OEUO": "高於{total}分"},
    "sort": ["OEUU", "OEUE", "OEUO"]
  },
  "PR": {
    "col": 2,
  ...
  "QRP": {
    "col": 3,
    "col188": 1,
    "text": {"QRPH": "{homeTeam}", "QRPN": "無", "QRPC": "{awayTeam}"},
    "sort": ["QRPH", "QRPN", "QRPC"]
  },
  "FP": {
    "col": 2,
  ...
  "WMA": {
    ...
    "col188": 1,
    "text": {
      "WMH6OV": "{homeTeam}贏6分以上",
      "WMC6OV": "{awayTeam}贏6分以上",
      "WM5": "任一隊伍贏5分或更少",
    },
  ...
  "WMC": {
    ...
    "text": {
      'WMH15': '{homeTeam}贏1-5分',
      'WMH610': '{homeTeam}贏6-10分',
      'WMH1115': '{homeTeam}贏11-15分',
      'WMH1620': '{homeTeam}贏16-20分',
      'WMH2125': '{homeTeam}贏21-25分',
      'WMH26OV': '{homeTeam}贏26分以上',
      'WMC15': '{awayTeam}贏1-5分',
      'WMC610': '{awayTeam}贏6-10分',
      'WMC1115': '{awayTeam}贏11-15分',
      'WMC1620': '{awayTeam}贏16-20分',
      'WMC2125': '{awayTeam}贏21-25分',
      'WMC26OV': '{awayTeam}贏26分以上',
    },
    "sort": [
  ...
  "RWMA": {
    ...
    "col188": 1,
    "text": {
      "RWMH6OV": "{homeTeam}贏6分以上",
      "RWMC6OV": "{awayTeam}贏6分以上",
      "RWM5": "任一隊伍贏5分或更少",
    },
  ...
  "RWMC": {
    ...
    "col188": 1,
    "text": {
      'RWMH15': '{homeTeam} 贏1-5分',
      'RWMH610': '{homeTeam} 贏6-10分',
      'RWMH1115': '{homeTeam} 贏11-15分',
      'RWMH1620': '{homeTeam} 贏16-20分',
      'RWMH2125': '{homeTeam} 贏21-25分',
      'RWMH26OV': '{homeTeam} 贏26分以上',
      'RWMC15': '{awayTeam} 贏1-5分',
      'RWMC610': '{awayTeam} 贏6-10分',
      'RWMC1115': '{awayTeam} 贏11-15分',
      'RWMC1620': '{awayTeam} 贏16-20分',
      'RWMC2125': '{awayTeam} 贏21-25分',
      'RWMC26OV': '{awayTeam} 贏26分以上',
    },
    "sort": [
      'RWMH15',   'RWMC15',
      'RWMH610',  'RWMC610',
  ...
  'RWM': {
    ...
    "col188": 1,
    'text': {
      "RWMH12": "{homeTeam} 贏1-2分",
      "RWMH36": "{homeTeam} 贏3-6分",
      "RWMH79": "{homeTeam} 贏7-9分",
      "RWMH1013": "{homeTeam} 贏10-13分",
      "RWMH1416": "{homeTeam} 贏14-16分",
      "RWMH1720": "{homeTeam} 贏17-20分",
      "RWMH21OV": "{homeTeam} 贏21分以上",
      "RWMC12": "{awayTeam} 贏1-2分",
      "RWMC36": "{awayTeam} 贏3-6分",
      "RWMC79": "{awayTeam} 贏7-9分",
      "RWMC1013": "{awayTeam} 贏10-13分",
      "RWMC1416": "{awayTeam} 贏14-16分",
      "RWMC1720": "{awayTeam} 贏17-20分",
      "RWMC21OV": "{awayTeam} 贏21分以上",
    },
    'sort': [
      "RWMH12", "RWMC12",
      "RWMH36", "RWMC36",
