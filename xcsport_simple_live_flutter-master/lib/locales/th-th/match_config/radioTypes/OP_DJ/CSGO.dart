...
const dynamic csgoRadioTypes = {
  ...
  'MOU_RT': {
    'col': 2,
    'text': {'MOU_RTO': '。สูง {ratio}', 'MOU_RTU': 'ต่ำ {ratio}'},
  ...
  'MEO_MR': {
    'col': 2,
    'text': {'MEO_MRO': 'คี่', 'MEO_MRE': 'คู่'},
    'sort': ['MEO_MRO', 'MEO_MRE']
  },
  'MOU_TH': {
    'col': 2,
    'text': {'MOU_THO': 'สูง {ratio}', 'MOU_THU': 'ต่ำ {ratio}'},
    'sort': ['MOU_THO', 'MOU_THU']
  },
  'MOU_RXT': {
    'col': 2,
    'text': {'MOU_RXTO': 'สูง{ratio}', 'MOU_RXTU': 'ต่ำ {ratio}'},
  ...
  'MOU_TKH': {
    'col': 2,
    'text': {'MOU_TKHO': 'สูง {ratio}', 'MOU_TKHU': 'ต่ำ {ratio}'},
    'sort': ['MOU_TKHO', 'MOU_TKHU']
  },
  'MOU_TKC': {
    'col': 2,
    'text': {'MOU_TKCO': 'สูง {ratio}', 'MOU_TKCU': 'ต่ำ {ratio}'},
    'sort': ['MOU_TKCO', 'MOU_TKCU']
  },
  'MRBP': {
    'col': 2,
    'text': {'MRBPY': 'ใช่', 'MRBPN': 'ไม่'},
    'sort': ['MRBPY', 'MRBPN']
  },
  'MRBD': {
    'col': 2,
    'text': {'MRBDY': 'ใช่', 'MRBDN': 'ไม่'},
    'sort': ['MRBDY', 'MRBDN']
  },
  ...
  'CT': {
    'col': 2,
    'text': {'CT33': '33:00หรือต่ำกว่า', 'CT34': '33:01หรือสูงกว่า'},
    'sort': ['CT33', 'CT34']
  }
};
