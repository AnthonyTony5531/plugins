const dynamic lolRadioTypes = {
  ...
  'CT': {
    'col': 2,
    'text': {'CT33': '35:00หรือต่ำกว่า', 'CT34': '35:01หรือสูงกว่า'},
    'sort': ['CT33', 'CT34']
  },
  ...
  'M_CT1': {
    'col': 2,
    'text': {'M_CT1O': 'สูง {ratio}', 'M_CT1U': 'ต่ำ {ratio}'},
    'sort': ['M_CT1O', 'M_CT1U']
  },
  'M_FB1': {
    'col': 2,
  ...
  'M_CT2': {
    'col': 2,
    'text': {'M_CT2O': 'ใหญ่ {ratio}', 'M_CT2U': 'เล็ก {ratio}'},
    'sort': ['M_CT2O', 'M_CT2U']
  },
  'M_FB2': {
    'col': 2,
  ...
  'M_FEO1': {
    'col': 2,
    'text': {'M_FEO1O': 'คี่', 'M_FEO1E': 'คู่'},
    'sort': ['M_FEO1O', 'M_FEO1E']
  },
  'M_FOU1': {
    'col': 2,
    'text': {'M_FOU1H': 'สูง {ratio}', 'M_FOU1C': 'ต่ำ {ratio}'},
  ...
  'M_FEO2': {
    'col': 2,
    'text': {'M_FEO2O': 'คี่', 'M_FEO2E': 'คู่'},
    'sort': ['M_FEO2O', 'M_FEO2E']
  },
  'M_FOU2': {
    'col': 2,
    'text': {'M_FOU2H': 'สูง {ratio}', 'M_FOU2C': 'ต่ำ {ratio}'},
