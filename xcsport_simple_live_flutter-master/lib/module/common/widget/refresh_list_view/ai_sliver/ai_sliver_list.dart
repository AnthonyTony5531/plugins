...
/// * ClassName: ai_sliver_list
/// * Description: dart类作用描述
/// * Author: Grey
/// * CreateDate: 2020/12/31 10:04

typedef OnSlideIndexChanged = Function(
  int firstIndex,
  int lastIndex,
  RenderObject firstObj,
  RenderObject lastObj,
  double firstOffset,
  double lastOffset,
);

class AiSliverList extends SliverMultiBoxAdaptorWidget {
  final OnSlideIndexChanged onIndexChanged;
  ...
  @override
  AiRenderSliverList createRenderObject(BuildContext context) {
    final SliverMultiBoxAdaptorElement element = context;
    return AiRenderSliverList(childManager: element, onIndexChanged: onIndexChanged);
  }
}

class AiRenderSliverList extends RenderSliverMultiBoxAdaptor {
  final OnSlideIndexChanged onIndexChanged;
  ...
  void performLayout() {
    ...
    if (onIndexChanged != null) {
      onIndexChanged(firstIndex, lastIndex, firstChild, lastChild, leadingScrollOffset, endScrollOffset);
    }
