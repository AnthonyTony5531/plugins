...
class AiRefreshView extends StatelessWidget {
  final Widget child;
  ...
  RefreshIndicatorMode freshStatus;
  @override
    ...
    return ScRefreshView(
      ...
      freshHeaderBuilder: (context, value, freshStatus) {
        ...
        if (RefreshIndicatorMode.drag == freshStatus) {
          ...
          text = "松手即可刷新";
          this.freshStatus = RefreshIndicatorMode.armed;
        } else if (RefreshIndicatorMode.refresh == freshStatus) {
          if (RefreshIndicatorMode.armed == this.freshStatus) {
            this.freshStatus = RefreshIndicatorMode.refresh;
            Future(() {
              _doVibrate();
            });
          }
