...
class AiSeekBar extends StatefulWidget {
  ...
  final ValueChanged<double>  onStartTrackingTouch;
  ...
  @override
  _AiSeekBarState createState() {
    return _AiSeekBarState();
  }
}

class _AiSeekBarState extends State<AiSeekBar> {
  ...
  @override
  void didUpdateWidget(AiSeekBar oldWidget) {
    _value = widget.value > 1 ? 1 : widget.value < 0 ? 0 : widget.value;
    _secondValue = widget.secondValue > 1
        ? 1
        : widget.secondValue < 0 ? 0 : widget.secondValue;
    ...
    return GestureDetector(
      ...
      onHorizontalDragEnd: (_){
        ...
        if (widget.onStopTrackingTouch != null) {
          widget.onStopTrackingTouch(_value);
        }
      },
      onTapUp: (_){
        setState(() {
