...
const double _dragDownEventHeight = 50.0;
// TODO： 因小游戏内部COCOS2D游戏有列表，与flutter下拉动画冲突，现在禁止下拉；与官方相比：组件下拉动画仅部位头部50像素，官方是全组件可下拉
...
class _BottomSheetState extends State<BottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    // );
    // TODO：以上为官方源码
    return !widget.enableDrag ? bottomSheet : Stack(
      children: [
        bottomSheet,
        Positioned(
          top: 0,
...
Future<T> aiShowModalBottomSheet<T>({
...
PersistentBottomSheetController<T> aiShowBottomSheet<T>({
  @required BuildContext context,
  @required WidgetBuilder builder,
  Color backgroundColor,
  double elevation,
