...
/// [NoKeyBoardTextEditingController], the text field updates [value] and the controller
...
///
/// A [NoKeyBoardTextEditingController] can also be used to provide an initial value for a
...
///
/// Remember to [dispose] of the [NoKeyBoardTextEditingController] when it is no longer needed.
/// This will ensure we discard any resources used by the object.
/// {@tool dartpad --template=stateful_widget_material}
/// This example creates a [TextField] with a [NoKeyBoardTextEditingController] whose
...
///  * [NoKeyBoardEditableText], which is a raw region of editable text that can be
///    controlled with a [TextEditingController].
///  * Learn how to use a [NoKeyBoardTextEditingController] in one of our [cookbook recipes](https://flutter.dev/docs/cookbook/forms/text-field-changes#2-use-a-texteditingcontroller).
class NoKeyBoardTextEditingController extends ValueNotifier<TextEditingValue> {
  /// Creates a controller for an editable text field.
  ///
  /// This constructor treats a null [text] argument as if it were the empty
  /// string.
  NoKeyBoardTextEditingController({ String text })
  ...
  NoKeyBoardTextEditingController.fromValue(TextEditingValue value)
      : assert(
  ...
  /// Setting this will notify all the listeners of this [NoKeyBoardTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
  /// this value should only be set between frames, e.g. in response to user
  /// actions, not during the build, layout, or paint phases.
  ///
  /// This property can be set from a listener added to this
  /// [NoKeyBoardTextEditingController]; however, one should not also set [selection]
  ...
  ///
  /// This property can be set from a listener added to this
  /// [NoKeyBoardTextEditingController]; however, one should not also set [text]
  /// in a separate statement. To change both the [text] and the [selection]
  /// change the controller's [value].
  ...
  ///
  /// Calling this will notify all the listeners of this [NoKeyBoardTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
...
/// Toolbar configuration for [NoKeyBoardEditableText].
///
/// Toolbar is a context menu that will show up when user right click or long
/// press the [NoKeyBoardEditableText]. It includes several options: cut, copy, paste,
/// and select all.
///
/// [NoKeyBoardEditableText] and its derived widgets have their own default [NoKeyBoardToolbarOptions].
/// Create a custom [NoKeyBoardToolbarOptions] if you want explicit control over the toolbar
/// option.
class NoKeyBoardToolbarOptions {
  /// Create a toolbar configuration with given options.
  ///
  /// All options default to false if they are not explicitly set.
  const NoKeyBoardToolbarOptions({
    this.copy = false,
    this.cut = false,
    this.paste = false,
  ...
  ///
  /// If [NoKeyBoardEditableText.readOnly] is set to true, cut will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool cut;
  ...
  ///
  /// If [NoKeyBoardEditableText.readOnly] is set to true, paste will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool paste;
...
class NoKeyBoardEditableText extends StatefulWidget {
  ...
  NoKeyBoardEditableText({
    ...
    this.toolbarOptions = const NoKeyBoardToolbarOptions(
      copy: true,
      cut: true,
      paste: true,
      selectAll: true,
  ...
  final NoKeyBoardTextEditingController controller;
  ...
  final NoKeyBoardToolbarOptions toolbarOptions;
  ...
  ///
  /// The cursor refers to the blinking caret when the [NoKeyBoardEditableText] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  ///
  /// The [NoKeyBoardEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [NoKeyBoardEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [NoKeyBoardEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [NoKeyBoardEditableText], which
  ...
  /// [NoKeyBoardTextEditingController.addListener].
  ///
  /// {@tool dartpad --template=stateful_widget_material}
  ///
  ...
  /// [NoKeyBoardEditableText] internally, and uses the value of `onFieldSubmitted` as its
  /// [onSubmitted]).
  ///
  /// ```dart
  ...
  ///
  /// The [mouseCursor] is the only property of [NoKeyBoardEditableText] that controls the
  ...
  /// [NoKeyBoardEditableText].
  ///
  /// If a restoration id is provided, the [NoKeyBoardEditableText] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [NoKeyBoardEditableText] is the
  ...
  @override
  NoKeyBoardEditableTextState createState() => NoKeyBoardEditableTextState();

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<NoKeyBoardTextEditingController>('controller', controller));
...
/// State for a [NoKeyBoardEditableText].
class NoKeyBoardEditableTextState extends State<NoKeyBoardEditableText> with AutomaticKeepAliveClientMixin<NoKeyBoardEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<NoKeyBoardEditableText> implements TextSelectionDelegate, TextInputClient, AutofillClient {
  Timer _cursorTimer;
  ...
  @override
  void didUpdateWidget(NoKeyBoardEditableText oldWidget) {
  ...
  void _startCursorTimer() {
    ...
    if (NoKeyBoardEditableText.debugDeterministicCursor)
      return;
    if (widget.cursorOpacityAnimates) {
          ...
          return CompositedTransformTarget(
            ...
            child: Semantics(
              ...
              child: _Editable(
                ...
                showCursor: NoKeyBoardEditableText.debugDeterministicCursor
