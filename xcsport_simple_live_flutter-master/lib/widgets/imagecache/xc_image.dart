...
class XcImage extends StatefulWidget {
  ...
  XcImage.network(
    ...
    int cacheWidth,
    int cacheHeight,
  }) : image = ResizeImage.resizeIfNeeded(cacheWidth, cacheHeight, xcNetWorkImage.NetworkImage(src, scale: scale, headers: headers)),
       assert(alignment != null),
       assert(repeat != null),
       assert(matchTextDirection != null),
  ...
  @override
  _XcImageState createState() => _XcImageState();
...
class _XcImageState extends State<XcImage> with WidgetsBindingObserver {
  ...
  DisposableBuildContext<State<XcImage>> _scrollAwareContext;
  ...
  void initState() {
    ...
    _scrollAwareContext = DisposableBuildContext<State<XcImage>>(this);
  }
  ...
  @override
  void didUpdateWidget(XcImage oldWidget) {
