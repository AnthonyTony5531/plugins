...
/// {@end-tool}
///
/// 修改自FadeInImage,在FadeInImage基础上增加XcFadeInImage.assetNetwork了从磁盘加载缓存的图片功能
///
class XcFadeInImage extends StatelessWidget {
  ...
  XcFadeInImage.memoryNetwork({
    ...
    this.needAnimation = true,
       ...
       image = ResizeImage.resizeIfNeeded(imageCacheWidth, imageCacheHeight, xcNetWorkImage.NetworkImage(image, scale: imageScale)),
       super(key: key);
  ...
  Widget build(BuildContext context) {
    Widget result = _image(
      ...
      frameBuilder: needAnimation ? (BuildContext context, Widget child, int frame, bool wasSynchronouslyLoaded) {
