...
class AiAppPageViewModel extends StatefulViewModel<AiAppPageStyle>{

  AiAppPageViewModel();

  //参数传给view时候，在这初始化统一入口初始化，自己要啥扩展参数。注意。Page和Dialog.page参数来源于View的构造函数，
  AiAppPageViewModel.create();
 ...
 //initState时候同步调用，同步方法。这里不能做io, cache读写.查询等耗时操作。
  ...
  void didModelUpdate(IViewModel o, IViewModel n){
   AiAppPageViewModel  oldeViewModel = o as AiAppPageViewModel;
   AiAppPageViewModel  newViewModel = n as AiAppPageViewModel;
  }
  ...
  @override
  List<AiAppPageStyle> get styleList => [ AiAppPageStyle()];
}