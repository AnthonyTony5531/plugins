...
import 'ai_flexible_space_bar.dart';

const double kToolbarHeight = 48.0;
...
class AiAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  AiAppBar({
    ...
    this.primary = true,
    this.centerTitle,
    this.removeLeadingPadding=false,
    ...
    this.isApp=true,
       ...
       preferredSize = customPreferredSize ?? Size.fromHeight(kToolbarHeight + (bottom?.preferredSize?.height ?? 0.0)),
       super(key: key);
  ...
  final bool removeLeadingPadding;
...
class _AppBarState extends State<AiAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading != null && !widget.removeLeadingPadding) {
    ...
    final Widget toolbar = NavigationToolbar(
      leading: widget.isApp ? leading : SizedBox(width:0,),
      middle: title,
      trailing: actions,
      centerMiddle: widget.isApp ? widget._getEffectiveCenterTitle(themeData) : false,
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    final Widget appBar = AiFlexibleSpaceBar.createSettings(
      minExtent: minExtent,
      maxExtent: maxExtent,
...
///    can expand and collapse.
///  * <https://material.io/design/components/app-bars-top.html>
class AiSliverAppBar extends StatefulWidget {
...
class _SliverAppBarState extends State<AiSliverAppBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(AiSliverAppBar oldWidget) {
