...
class AnchorShareService {
  static AnchorShareService ins = AnchorShareService();
  ...
  final List<BetShareMessage> _data = [];
  bool _isInitData = false; // 是否初始化数据
  bool _hasNewShare = false;
  bool _isHasShowing = false;
  BetShareMessage _curShowData;

  bool get isShowing => _isHasShowing;

  BetShareMessage get betShareMessage => _curShowData ?? null;
