...
class LoggerInfoView extends StatelessWidget {
  final TagLoggerInfoData infoData;

  const LoggerInfoView({@required this.infoData});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SaveWidgetView(value: infoData.getValue()),
              const SizedBox(height: 16.0),
              buildTextView(infoData.tagStr),
              buildTextView(infoData.createTimeStr),
              buildTextView(infoData.messageStr),
              buildTextView(infoData.stackStr),
            ],
          ),
        ),
      ),
