...
+ (NSDictionary *)xc_urls {
    return @{
        ...
        //NM01
        @(XCSDKConfigNM01) : @{
            XCSDKImUrlKey : @"ws://dev.nm01.yc365d.com",
            XCSDKImgUrlKey : @"http://dev.img.yc365d.com",
            XCSDKMainUrlKey : @"http://dev.nm01.yc365d.com",
        },
        //BetPre
        @(XCSDKConfigGBetPre) : @{
            XCSDKImUrlKey : @"ws://h5.juxiangbaojie.com",
            XCSDKImgUrlKey : @"https://img.juxiangbaojie.com",
            XCSDKMainUrlKey : @"https://h5.juxiangbaojie.com",
        },
        //BetPre
        @(XCSDKConfigCN2H603) : @{
            XCSDKImUrlKey : @"ws://cn2.h603.aisports.io",
            XCSDKImgUrlKey : @"http://cn2.img.aisports.io",
            XCSDKMainUrlKey : @"http://cn2.h603.aisports.io",
        }
    };
}
