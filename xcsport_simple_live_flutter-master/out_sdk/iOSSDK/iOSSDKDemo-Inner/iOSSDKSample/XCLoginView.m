...
@property (weak, nonatomic) IBOutlet UILabel *tabSubtitleLabel;
...
- (void)awakeFromNib{
    ...
    self.tabSubtitleLabel.textColor = TNColorWithHexA(0xFFFFFF, 0.7);
    self.iconTitleLabel.textColor = UIColor.whiteColor;
    self.iconSubtitleLabel.textColor = TNColorWithHexA(0xFFFFFF, 0.7);
    self.tabSDKBtn.backgroundColor = TNColorWithHex(0xFF8446);
    self.iconSDKBtn.backgroundColor = TNColorWithHex(0xFF8446);
#else
