...
| 2020-10-28 | 3.4.0 | Sam |1.新增默认的TabSdk加载启动页, 开发者不在需要关心和实现启动页，资源下载进度问题</br> 2.新增余额变化通知 </br>3.新增赛事详情页主播发红包</br>4.新增赛事详情注单分享</br>5.新增首屏推荐弹框</br>6.主播页面改版</br>7.修复已知bug|luton|
...
| 2021-01-11 | 3.7.0 | wilson |1.新增直接进入比赛主播直播间调用方法<br>2.新增横屏旋转回调事件<br>3.新增红包倒计时效果<br>4.新增提前结算功能<br>5.新增用户标签与主播标签<br>6.新增全部体育项栏目<br>7.优化比赛详情页性能<br>8.优化赔率点水交互效果<br>9.优化注单分享功能与跟投退单交互<br>10.优化列表盘口开关盘及时性<br>11.优化主播心愿单交互效果<br>12.优化比分、注单受理、主播开播、注单结算、红包等推送效果与性能<br>13.修复已知bug<br>| luton|
| 2021-01-20 | 3.7.0 | wilson |网络性能指标采集| luton|
| 2021-02-05 | 3.8.0 | wilson |1.新增清除缓存<br>2.资源下载支持断点续传<br>3.Tab版新增配置<br>4.优化下载资源包，下载资源减少18M<br>5.修复已知bug，增强系统稳定性<br> |luton |
| 2021-03-12 | 3.8.5V1 | wilson |1.优化提前结算功能，提升结算成功率。<br>2.新增足球注单记录查看赛果和比赛详情。<br>3.优化聊天室进入交互效果。 <br>4.修复比分遮罩层无法关闭bug。<br>5.修复比赛直播横屏投注金额输入错误问题。<br>6.修复系统维护时，页面显示错误问题。<br>7.Release apk包出java.lang.AbstractMethodError闪退修复办法<br> |luton |
| 2021-03-31 | 3.8.5V1 | wilson |1.增加调起sdk入参sdkType说明    |luton |
| 2021-04-06 | 3.9.0 | wilson |1.增加调起sdk入参renderMode,ui渲染模式设置及说明    |luton |
| 2021-11-12 | 3.15.1 | wilson |1.对外提供视频播放、暂停控制功能。<br>2.过场页面调起FastAiManagerProxy.get().pushTabSdkLauncherPage()添加3个参数。<br>3.增加入参useSdkPermissionCtrl应用权限申请方声明   |luton |
| 2021-11-20 | 3.16.0 | Sam |1.添加老鸟，新手，清爽版设置  |luton |
...
>>>> ###### [2.4.2.充值通知 ] (#event_2)
>>>> ###### [2.4.3.提现通知 ] (#event_3)
>>>> ###### [2.4.4.SDK关闭通知 ] (#event_4)
>>>> ###### [2.4.5.嵌入式版本启动页加载事件 ] (#event_5)
>>>> ###### [2.4.6.隐藏底底部栏目通知 ] (#event_6)
>>>> ###### [2.4.7.显示底部栏目通知 ] (#event_7)
>>>> ###### [2.4.8.余额变化通知 ] (#event_8)
>>>> ###### [2.4.9.运维503通知 ] (#event_9)
>>>> ###### [2.4.10.Token失效通知 ] (#event_10)
>>>> ###### [2.4.11.向SDK更新Token事件 ] (#event_11)
>>>> ###### [2.4.12.SDK调用横屏回调事件 ] (#event_12)
>>>> ###### [2.4.13.外部通知SDK暂停视频播放 ] (#event_13)
>>>> ###### [2.4.14.外部通知SDK重新播放视频 ] (#event_14)
>>>> ###### [2.4.15.需要登陆通知 ] (#event_15)
...
>>> ##### [2.6 直接进入主播直播间 ] (#enter_anchor_room)
>>> ##### [2.7 Tab版新特性 ] (#tab_sdk_new_feature)
>>>> ###### [2.7.1.Tab SDK加载资源或启动是否展示底部TabBar ] (#tab_sdk_new_feature_show_tab_bar_on_load)
...
> #### [五、接入TabSdk加载启动页, 底部导航栏的隐藏和显示容器](#laucher_nav)
...
##### <span id="tab_sdk_new_feature_show_tab_bar_on_load" >2.7.1.Tab SDK加载资源或启动是否展示底部TabBar</span>
