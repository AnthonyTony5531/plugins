...
class CupertinoDatePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    switch (mode) {
      ...
      case CupertinoDatePickerMode.onlyMonth:
        return _CupertinoDatePickerOnlyMonthState();
    }
...
class _CupertinoDatePickerOnlyMonthState extends State<CupertinoDatePicker> {
  int textDirectionFactor;
  CupertinoLocalizations localizations;
...
//          estimatedColumnWidths[_PickerColumnType.dayOfMonth.index],
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      if (i == 1) {
        offAxisFraction = i * 0.3 * textDirectionFactor;
      }
...
class _CupertinoTimerPickerState extends State<CupertinoTimerPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    const double paddingValue =
        _kPickerWidth - 2 * _kTimerPickerColumnIntrinsicWidth - 2 * _kTimerPickerHalfColumnPadding;
    ...
    switch (widget.mode) {
      case CupertinoTimerPickerMode.hm:
        ...
        columns = <Widget>[
          _buildHourColumn(
              const EdgeInsetsDirectional.only(start: paddingValue / 2, end: _kTimerPickerHalfColumnPadding)),
          _buildMinuteColumn(
              const EdgeInsetsDirectional.only(start: _kTimerPickerHalfColumnPadding, end: paddingValue / 2)),
        ];
        break;
      case CupertinoTimerPickerMode.ms:
        // Pad the widget to make it as wide as `_kPickerWidth`.
      ...
      case CupertinoTimerPickerMode.hms:
        ...
        columns = <Widget>[
          ...
          _buildMinuteColumn(const EdgeInsetsDirectional.only(
              start: _kTimerPickerHalfColumnPadding, end: _kTimerPickerHalfColumnPadding)),
          _buildSecondColumn(
              const EdgeInsetsDirectional.only(start: _kTimerPickerHalfColumnPadding, end: paddingValue / 2)),
        ];
        break;
