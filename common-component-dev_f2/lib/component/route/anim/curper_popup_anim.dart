...
///    platform-appropriate transitions for a [PopupRoute]
///  * [CupertinoPopupRoute], which is a [PopupRoute] that leverages this mixin.
mixin CupertinoRouteTransitionMixin<T> on PopupRoute<T> {
  ...
  /// The title string of the previous [CupertinoPopupRoute].
  ///
  ...
  ///
  /// Used by [CupertinoPopupRoute.buildTransitions].
  ///
  /// This method can be applied to any [PopupRoute], not just
  /// [CupertinoPopupRoute]. It's typically used to provide a Cupertino style
...
///  * [MaterialPopupRoute], for an adaptive [PopupRoute] that uses a
...
// A page-based version of CupertinoPopupRoute.
//
// This route uses the builder from the page to build its content. This ensures
// the content is up to date after page updates.
class _PageBasedCupertinoPopupRoute<T> extends PopupRoute<T>
    with CupertinoRouteTransitionMixin<T> {
  _PageBasedCupertinoPopupRoute({
...
/// A page that creates a cupertino style [PopupRoute].
///
/// {@macro flutter.cupertino.cupertinoRouteTransitionMixin}
///
...
/// See also:
///
///  * [CupertinoPopupRoute], for a [PopupRoute] version of this class.
class CupertinoPage<T> extends Page<T> {
  ...
  /// {@macro flutter.widgets.PopupRoute.fullscreenDialog}
  final bool fullscreenDialog;

  @override
  Route<T> createRoute(BuildContext context) {
    return _PageBasedCupertinoPopupRoute<T>(page: this);
  }
}
...
///
/// This is created by a [CupertinoPopupRoute] in response from a gesture caught
